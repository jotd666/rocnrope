...
6063: AD B4          JSR    [A,X]		; [indirect_jump] [nb_entries=16]
6065: 4F             CLRA
...
60FB: 4F             CLRA
60FC: C6 A8          LDB    #$80
60FE: 36 BA          PSHU   Y,X,A   ; [video_address_word]
6100: 36 10          PSHU   Y,X,A   ; [video_address_word]
6102: 36 B0          PSHU   Y,X,A   ; [video_address_word]
6104: 36 20          PSHU   A    ; [video_address_word]
6106: 5A             DECB
6107: 26 DD          BNE    $60FE
...
632A: 31 B7          LEAY   -$1,Y
632C: 26 CA          BNE    $6310
632E: 6E 6C          JMP    ,S		; during system tests
...
6443: 97 53          STA    $71
6445: 86 92          LDA    #$10
6447: E7 A1 D4 88    STB    -$0400,X		; [video_address]
644B: A7 A8          STA    ,X+		; [video_address]
644D: 0A F9          DEC    $71
644F: 26 D4          BNE    $6447
6451: 3C 6D          CWAI   #$EF		; sync with irq to clear "H" from screen
6453: 0A 52          DEC    $70
6455: 26 68          BNE    $6441
6457: C6 28          LDB    #$00
...
6472: 8D AF          BSR    $64A1
6474: C6 22          LDB    #$00
6476: CE D2 8E       LDU    #end_score_50a6
6479: 8E C5 57       LDX    #$4DDF
647C: BD 4F F5       JSR    $677D
647F: 0D 00          TST    game_in_play_22
6481: 27 86          BEQ    $6487
6483: 96 03          LDA    $21
6485: 97 3D          STA    $BF
6487: 0D 97          TST    $BF
...
64A5: 27 8F          BEQ    $64B4
64A7: 80 18          SUBA   #$30
64A9: A7 0C          STA    ,X		; [video_address]
64AB: E7 A1 D4 88    STB    -$0400,X		; [video_address]
...
64D6: 27 76          BEQ    $64CC
64D8: C0 18          SUBB   #$30
64DA: A7 01 D4 28    STA    -$0400,X		; [video_address]
64DE: E7 0C          STB    ,X		; [video_address]
...
64F6: 27 76          BEQ    $64EC
64F8: C6 38          LDB    #$10
64FA: E7 0C          STB    ,X		; [video_address]
64FC: A7 A1 74 88    STA    -$0400,X		; [video_address]
...
add_to_score_6718:
6718: 0D 0A          TST    game_in_play_22
671A: 27 E8          BEQ    $677C
671C: 58             ASLB
...
6726: 0D A2          TST    $20
6728: 27 2B          BEQ    $672D
672A: 8E D8 8E       LDX    #end_score_50a6
672D: A6 0A          LDA    ,-X
672F: AB 80          ADDA   ,-Y
6731: 19             DAA
6732: A7 06          STA    ,X
...
674D: D1 20          CMPB   $A8
674F: 25 37          BCS    $6766
6751: CE D2 24       LDU    #end_score_50a6
6754: EC A6          LDD    ,X
6756: ED 46          STD    ,U
6758: E6 2A          LDB    $2,X
675A: E7 CA          STB    $2,U
675C: C6 38          LDB    #$10
675E: CE D8 84       LDU    #end_score_50a6
...
67CB: A6 6A          LDA    $2,U
67CD: 84 87          ANDA   #$0F
67CF: E7 AB DE 82    STB    -$0400,X		; [video_address]
67D3: A7 A6          STA    ,X		; [video_address]
...
681D: CE D8 2E       LDU    #end_score_50a6
...
l_686d:
686D: 96 25          LDA    $AD
686F: A7 AB DE 82    STA    -$0400,X		; [video_address]
6873: A7 AB DE A2    STA    -$03E0,X		; [video_address]
6877: A7 A1 D4 C8    STA    -$03C0,X		; [video_address]
687B: A6 C8          LDA    ,S+		; [target_stack_store] 
687D: 26 9B          BNE    $6892
687F: 86 32          LDA    #$10
6881: A7 0A C2       STA    $40,X		; [video_address]
6884: A6 C2          LDA    ,S+		; [target_stack_store] 
6886: 26 80          BNE    $688A
6888: 86 38          LDA    #$10
688A: A7 0C          STA    ,X		; [video_address]
688C: A6 C8          LDA    ,S+		; [target_stack_store] 
688E: A7 00 02       STA    $20,X		; [video_address]
6891: 39             RTS
...
68B3: 27 D0          BEQ    $68A7
68B5: 80 B2          SUBA   #$30
68B7: A7 AC          STA    ,X				; [video_address]
68B9: E7 01 74 28    STB    -$0400,X			; [video_address]
...
68D1: 27 70          BEQ    $68C5
68D3: 86 32          LDA    #$10
68D5: A7 06          STA    ,X					; [video_address]
68D7: E7 A1 D4 88    STB    -$0400,X			; [video_address]
...
69E1: A6 26          LDA    ,Y
69E3: A7 A6          STA    ,X             ; [video_address]
69E5: 30 0B 7E 28    LEAX   -$0400,X       ; [video_address]
69E9: 10 9E F4       LDY    $7C
69EC: A6 8C          LDA    ,Y
69EE: A7 0C          STA    ,X		 ; [video_address]
69F0: 8D 3B          BSR    $6A0B
69F2: 0C F5          INC    $77
69F4: 96 55          LDA    $77
69F6: 81 9E          CMPA   #$1C
69F8: 10 26 77 3A    LBNE   $69AE
69FC: 3C C7          CWAI   #$EF		; sync with irq to make background appear
69FE: 0F FF          CLR    $77
6A00: 0C 54          INC    $76
6A02: 96 F4          LDA    $76
6A04: 81 3E          CMPA   #$1C
...
6A3D: 30 8A          LEAX   $2,X
6A3F: A6 A2          LDA    ,X+
6A41: A7 42          STA    ,U+		; [video_address]
6A43: 5A             DECB
6A44: 26 DB          BNE    $6A3F
6A46: C6 81          LDB    #$03
6A48: DE 52          LDU    $7A
6A4A: 33 41 D4 28    LEAU   -$0400,U
6A4E: A6 08          LDA    ,X+     ; [video_address]
6A50: A7 E2          STA    ,U+     ; [video_address]
6A52: 5A             DECB
6A53: 26 DB          BNE    $6A4E
6A55: 0C F5          INC    $77
6A57: 0C 5F          INC    $77
...
6DA8: ED AC          STD    ,X             ; [video_address_word]
...
7025: 48             ASLA
7026: DD DC          STD    $5E
7028: 0D 0A          TST    game_in_play_22
702A: 27 AB          BEQ    $704F
...
70BA: AD 1E          JSR    [A,X]        ; [indirect_jump] [nb_entries=5]
70BC: 86 29          LDA    #$01
...
718D: 96 0F          LDA    $87
718F: D6 A6          LDB    $84
7191: DD A0          STD    game_in_play_22
7193: DC A7          LDD    $85
...
732A: 0F 83          CLR    $0B
732C: 0F 26          CLR    $0E
732E: 0F AA          CLR    game_in_play_22
7330: 0C 20          INC    $02
7332: 39             RTS
...
7366: 6E 34          JMP    [A,Y]	; [indirect_jump] [nb_entries=2]

736C: CC 28 98       LDD    #$0010
...
748B: DD 08          STD    $20
748D: 86 89          LDA    #$01
748F: 97 00          STA    game_in_play_22
...
75C5: 6E 34          JMP    [A,Y]        ; [indirect_jump] [nb_entries=3]
...
76B7: 6E 9E          JMP    [A,Y]			; [indirect_jump] [nb_entries=2]
...
76D0: 26 3E          BNE    $76EE
76D2: 8D 99          BSR    $76EF
76D4: 8E 73 42       LDX    #player_state_51c0
...
7706: 10 8E 79 E8    LDY    #player_state_51c0
770A: EC 09          LDD    ,X++
770C: ED 89          STD    ,Y++
...
77CF: 6E 94          JMP    [A,Y]        ; [indirect_jump] [nb_entries=4]
...
780F: 8E 73 E2       LDX    #player_state_51c0
7812: 6F 8C          CLR    $E,X
...
785C: 0C 23          INC    $0B
785E: 39             RTS
785F: 8E 73 E2       LDX    #player_state_51c0
...
7A4F: C6 21          LDB    #$03
7A51: A6 46          LDA    ,U		; [video_address]
7A53: 84 D2          ANDA   #$F0
7A55: 9A E3          ORA    $61
7A57: A7 EC          STA    ,U		; [video_address]
...
7AB0: 6E 94          JMP    [A,Y]        ; [indirect_jump] [nb_entries=2]

7AB6: 96 8A          LDA    $08
7AB8: 48             ASLA
7AB9: 10 8E F2 97    LDY    #jump_table_7ABF
7ABD: 6E 3E          JMP    [A,Y]        ; [indirect_jump] [nb_entries=2]

7AC3: 96 29          LDA    $0B
7AC5: 48             ASLA
7AC6: 10 8E 52 E4    LDY    #jump_table_7acc
7ACA: 6E 3E          JMP    [A,Y]        ; [indirect_jump] [nb_entries=2]
...
7B2D: 48             ASLA
7B2E: 6E 1E          JMP    [A,X]        ; [indirect_jump] [nb_entries=9]

7B42: 35 12          PULS   X,PC
7B44: 39             RTS
7B45: 35 92          PULS   X
7B47: 86 2A          LDA    #$02
7B49: 20 DA          BRA    $7B9D
...
7B9D: 0D DA          TST    $52
7B9F: 26 26          BNE    $7BA5
7BA1: 0D A0          TST    game_in_play_22
7BA3: 27 30          BEQ    $7BB7
...
7BD8: 86 31          LDA    #$19
7BDA: 20 49          BRA    $7B9D
7BDC: 0D 0A          TST    game_in_play_22
7BDE: 27 9C          BEQ    $7BF4
7BE0: 96 E3          LDA    $C1
7BE2: 84 81          ANDA   #$03
7BE4: 8B 02          ADDA   #$20
...
7C2A: 0D AA          TST    game_in_play_22
7C2C: 27 2C          BEQ    $7C32
7C2E: 86 AC          LDA    #$24
7C30: 20 B2          BRA    $7BC2
7C32: 39             RTS
...
7C50: 0D A2          TST    $80
7C52: 26 8E          BNE    $7C60
7C54: 8E 73 42       LDX    #player_state_51c0
7C57: A6 2B          LDA    $3,X
7C59: 48             ASLA
7C5A: 10 8E 54 49    LDY    #jump_table_7c61
7C5E: 6E 3E          JMP    [A,Y]        ; [indirect_jump] [nb_entries=4]
7C60: 39             RTS
...
8527: A6 2B          LDA    $3,X
8529: 48             ASLA
852A: 6E 3E          JMP    [A,Y]        ; [indirect_jump] [nb_entries=3]
852C: 39             RTS

8533: 8E 76 22       LDX    #$5400
8536: A6 86          LDA    $4,X
8538: 80 3E          SUBA   #$16
853A: 81 4E          CMPA   #$C6
853C: 22 04          BHI    $856A
...
8564: 6A C6          DEC    ,S		; [target_stack_store]
8566: 26 77          BNE    $855D
...
8604: 6A C6          DEC    ,S		; [target_stack_store]
8606: 26 69          BNE    $85F3
...
86DC: 10 8E D9 48    LDY    #player_state_51c0
86E0: 6D A6          TST    ,X
86E2: 27 81          BEQ    $86E7
...
87DD: C6 8E          LDB    #$06
87DF: 34 36          PSHS   X,B		; [target_stack_push]
87E1: EC 06          LDD    ,X
87E3: 27 29          BEQ    $87F0
87E5: E6 81          LDB    $3,X
...
87EE: AE E9          LDX    $1,S	; [target_stack_load]
87F0: 30 AA A2       LEAX   $20,X
87F3: AF 43          STX    $1,S	; [target_stack_store]
87F5: 6A 66          DEC    ,S		; [target_stack_store]
87F7: 26 C0          BNE    $87E1
87F9: 35 1C          PULS   B,X,PC		; [target_stack_pull]

880D: E6 00 97       LDB    $1F,X
8810: 58             ASLB
8811: 10 8E 0A 35    LDY    #jump_table_8817
8815: 6E 37          JMP    [B,Y]        ; [indirect_jump] [nb_entries=4]
...
8922: 26 B0          BNE    $8956
8924: 10 8E D3 42    LDY    #player_state_51c0
8928: A6 0B          LDA    $3,Y
892A: 81 89          CMPA   #$01
892C: 26 00          BNE    $8956
...
8B84: 6E 94          JMP    [A,Y]        ; [indirect_jump] [nb_entries=3]
...
8CE1: 6E 34          JMP    [A,Y]        ; [indirect_jump] [nb_entries=4]
...
8D57: 6E 9E          JMP    [A,Y]        ; [indirect_jump] [nb_entries=2]
8D59: A6 87          LDA    $F,X
...
8DDF: 6E 94          JMP    [A,Y]        ; [indirect_jump] [nb_entries=8]
...
8FA8: 10 8E D9 48    LDY    #player_state_51c0
...
8FD3: 10 8E 73 42    LDY    #player_state_51c0
8FD7: 4F             CLRA
8FD8: 5F             CLRB
8FD9: DD E8          STD    $60
8FDB: EC 2C          LDD    $4,X
...
90FA: 6E 3E          JMP    [A,Y]        ; [indirect_jump] [nb_entries=5]
...
919A: 6E 3E          JMP    [A,Y]        ; [indirect_jump] [nb_entries=7]

91AA: 6D 00 31       TST    $19,X
91AD: 26 8D          BNE    $91B4
91AF: BD AD 8A       JSR    $8FA8
91B2: 20 8F          BRA    $91C1
91B4: E6 AA 9C       LDB    $1E,X
91B7: 58             ASLB
91B8: 58             ASLB
91B9: 58             ASLB
91BA: 58             ASLB
...
93EC: 6E 9E          JMP    [A,Y]        ; [indirect_jump] [nb_entries=3]

93F4: 34 32          PSHS   X
93F6: 10 8E 79 E8    LDY    #player_state_51c0
...
945A: A6 8B          LDA    $3,X
945C: 48             ASLA
945D: AD 3E          JSR    [A,Y]        ; [indirect_jump] [nb_entries=6]
945F: 30 AA 02       LEAX   $20,X
9462: 8C D1 BD       CMPX   #$539F
9465: 25 69          BCS    $9452
9467: 39             RTS

9474: BD B7 53       JSR    $95D1
...
99FF: 10 AE EA A0    LDY    game_in_play_22,U
9A03: 86 B5          LDA    #$97
9A05: C6 86          LDB    #$04
...
A407: 6E 9E          JMP    [A,Y]        ; [indirect_jump] [nb_entries=4]
...
A437: 6E 9E          JMP    [A,Y]        ; [indirect_jump] [nb_entries=2]

A43D: 10 8E 2D 78    LDY    #$A55A                                      
A441: 86 83          LDA    #$01
A443: A7 2D          STA    $F,X
...
A6ED: 81 89          CMPA   #$01
A6EF: 26 4F          BNE    $A75E
A6F1: 8E D3 42       LDX    #player_state_51c0
A6F4: 6D 21          TST    $3,X
A6F6: 26 E4          BNE    $A75E
...
A7BB: 8E 79 E8       LDX    #player_state_51c0
A7BE: 6D 0C          TST    ,X
A7C0: 27 2F          BEQ    $A7CF
A7C2: 6D 83          TST    $1,X
A7C4: 26 2B          BNE    $A7CF
...
A7CD: 6E 3D          JMP    [B,Y]        ; [indirect_jump] [nb_entries=5]
A7CF: 39             RTS
...
A8DB: 8E 79 E8       LDX    #player_state_51c0
A8DE: 8D 99          BSR    $A8F1
A8E0: 39             RTS
...
A944: C6 24          LDB    #$06
A946: 34 86          PSHS   B		; [target_stack_push]
A948: 6D AC          TST    ,X
A94A: 27 80          BEQ    $A954
A94C: A6 2B          LDA    $3,X
A94E: 81 8D          CMPA   #$05
...
A957: 6A CC          DEC    ,S		; [target_stack_store]
A959: 26 65          BNE    $A948
A95B: 35 AC          PULS   B,PC	; [target_stack_pull]
A95D: 6D 2C          TST    ,Y
A95F: 27 2C          BEQ    $A96F
A961: A6 A1          LDA    $3,Y
A963: 81 22          CMPA   #$00
...
A9A3: C6 24          LDB    #$06
A9A5: 34 86          PSHS   B		; [target_stack_push]
A9A7: E6 0B          LDB    $3,Y
...
A9C9: 6A 6C          DEC    ,S		; [target_stack_store]
A9CB: 26 F2          BNE    $A9A7
A9CD: 32 E9          LEAS   $1,S	; [target_stack_free]
...
A9F9: 81 9A          CMPA   #$12
A9FB: 22 36          BHI    $AA1B
A9FD: B6 D9 48       LDA    player_state_51c0
AA00: 81 20          CMPA   #$02
AA02: 27 9A          BEQ    $AA1C
AA04: A6 01          LDA    $3,Y
AA06: 81 87          CMPA   #$05
...
AA97: 39             RTS
AA98: 8E 79 48       LDX    #player_state_51c0
AA9B: 6D AC          TST    ,X
AA9D: 27 A2          BEQ    $AAC9
AA9F: 10 8E 70 82    LDY    #$5200
AAA3: C6 24          LDB    #$06
AAA5: 34 86          PSHS   B		; [target_stack_push]
AAA7: E6 0B          LDB    $3,Y
AAA9: C1 8E          CMPB   #$06
AAAB: 27 2E          BEQ    $AAB3
AAAD: C1 8B          CMPB   #$03
...
AAB6: 6A 66          DEC    ,S		; [target_stack_store]
AAB8: 26 C5          BNE    $AAA7
AABA: 32 E9          LEAS   $1,S	; [target_stack_free]
...
AB71: 8E D3 42       LDX    #player_state_51c0
AB74: 6D A6          TST    ,X
AB76: 27 9D          BEQ    $AB97
...
ABC7: 39             RTS
ABC8: 39             RTS
ABC9: 8E D9 48       LDX    #player_state_51c0
ABCC: 96 E9          LDA    $C1
ABCE: 84 8B          ANDA   #$03
ABD0: 48             ASLA
...
AC25: C6 86          LDB    #$04
AC27: 34 3C          PSHS   X,B		; [target_stack_push]
AC29: 6D 0C          TST    ,X
AC2B: 27 20          BEQ    $AC35
AC2D: 6D 89          TST    $1,X
AC2F: 26 26          BNE    $AC35
AC31: 8D 8F          BSR    $AC40
AC33: AE 43          LDX    $1,S	; [target_stack_load]
AC35: 30 0A 92       LEAX   $10,X
AC38: AF 49          STX    $1,S	; [target_stack_store]
AC3A: 6A 6C          DEC    ,S		; [target_stack_store]
AC3C: 26 C3          BNE    $AC29
AC3E: 35 1C          PULS   B,X,PC		; [target_stack_pull]
...
ACC9: 26 A4          BNE    $ACF7
ACCB: 34 08          PSHS   Y
ACCD: 10 8E D9 E2    LDY    #player_state_51c0
ACD1: E6 26          LDB    ,Y
ACD3: 5A             DECB
ACD4: 26 30          BNE    $ACE8
ACD6: A7 26          STA    ,Y
...
ACFC: 81 2A          CMPA   #$02
ACFE: 26 CA          BNE    $AD42
AD00: 8E 73 42       LDX    #player_state_51c0
AD03: A6 21          LDA    $3,X
AD05: 81 83          CMPA   #$01
AD07: 27 11          BEQ    $AD42
AD09: 81 8B          CMPA   #$03
...
AD74: 81 21          CMPA   #$03
AD76: 26 C2          BNE    $ADB8
AD78: 8E 79 48       LDX    #player_state_51c0
AD7B: 6D AC          TST    ,X
AD7D: 27 B1          BEQ    $ADB8
...
AEB2: 8E D3 E2       LDX    #player_state_51c0
AEB5: A6 06          LDA    ,X
AEB7: 81 2A          CMPA   #$02
AEB9: 26 8C          BNE    $AEBF
AEBB: 8D 0C          BSR    $AEE1
...
AF05: 8E D3 42       LDX    #player_state_51c0
AF08: 6D 2B          TST    $3,X
...
B686: 0C 40          INC    $C2
B688: 39             RTS
B689: 0D AA          TST    game_in_play_22
B68B: 27 12          BEQ    $B6C7
...
B6DA: 39             RTS
B6DB: 8E 79 E8       LDX    #player_state_51c0
...
D4C6: 6E 34          JMP    [A,Y]        ; [indirect_jump] [nb_entries=5]

D4D2: 0F A2          CLR    $20
D4D4: 0F 03          CLR    $21
D4D6: BD EC D0       JSR    $6EF8
D4D9: CC 80 88       LDD    #$0800
...
D4EB: 8E 79 E8       LDX    #player_state_51c0
...
D72E: 8E D9 E2       LDX    #player_state_51c0
...
D7AB: 26 D1          BNE    $D7A6
D7AD: 39             RTS
D7AE: 8E D9 E2       LDX    #player_state_51c0
D7B1: 86 A2          LDA    #$20
D7B3: 6F A2          CLR    ,X+
D7B5: 4A             DECA
D7B6: 26 79          BNE    $D7B3
...
DB37: 8E 79 C8       LDX    #$51E0
DB3A: C6 9A          LDB    #$12
DB3C: BD FF 39       JSR    $D7B1
DB3F: BD 59 D7       JSR    $7BF5
DB42: BD 55 83       JSR    $D7A1
DB45: 96 43          LDA    $C1
DB47: 84 2B          ANDA   #$03
DB49: 48             ASLA
DB4A: 8E 53 67       LDX    #jump_table_db4f
DB4D: 6E 1E          JMP    [A,X]        ; [indirect_jump] [nb_entries=3]
...
DB72: 1E B2          EXG    U,D
DB74: E7 AB 7E 82    STB    -$0400,X           ; [video_address]
DB78: A7 A8          STA    ,X+                ; [video_address]
DB7A: E7 01 D4 28    STB    -$0400,X           ; [video_address]
DB7E: A7 08          STA    ,X+                ; [video_address]
DB80: E7 AB 7E 82    STB    -$0400,X           ; [video_address]
DB84: A7 A6          STA    ,X                 ; [video_address]
...
DBDA: 8E D9 E8       LDX    #player_state_51c0
...
DC62: 8E D3 E2       LDX    #player_state_51c0
...
DC88: 8E 79 48       LDX    #player_state_51c0
...
DD0F: 8E 73 E2       LDX    #player_state_51c0
...
DD3A: 8E D9 E8       LDX    #player_state_51c0
...
DD7E: BD F3 D7       JSR    $7BF5
DD81: BD 55 23       JSR    $D7A1
DD84: C6 3A          LDB    #$18
...
DECF: 8E 73 E2       LDX    #player_state_51c0
